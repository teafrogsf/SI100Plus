...
- CNN，即卷积神经网络（Convolutional Neural Networks），是一种专门用于处理具有类似网格结构数据（比如图像）的深度学习模型。
  - 刚刚展示的 `ResNet101` 就是经典的 CNN 网络模型
...
<img src="kernel.gif" width="400" style="display: block; margin: 0 auto;"/>
...
<img src="image-13.png" width="400"  style="display: block; margin: 0 auto;"/>
