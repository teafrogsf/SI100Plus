...
## Chatbot的现在： <img src="image-3.png" width=50>      Chatgpt   
...
<img src="LOL.gif" width=300/> <img  src="LOL_.gif" height=300 width=450/> 

* LOL中，我们可以通过鼠标点击的方法让英雄寻路到指定地点
* LOL是如何计算英雄到指定地点的路线呢？
* 一个很容易想到的方法就是穷举法，通过遍历地图内的所有路径，从而选取一条英雄当前位置到终点的路径
