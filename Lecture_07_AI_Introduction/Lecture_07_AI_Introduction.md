...
## Chatbot 的现在：<img src="images/image-3.png" width="5%"> ChatGPT
...
- 如何相对高效地寻找到一条相对短的路径呢？
  - 我们总是希望距离越短越好，所以……
  - 我们可以**优化**我们的选择
  - 在决定下一次走的方向前，看一下在能走的点中，哪个离目标位置的距离最近
...
<div style="display: flex; justify-content: center; align-items: center; height: 700px; position: absolute; top: 0; background: #FFFC">
