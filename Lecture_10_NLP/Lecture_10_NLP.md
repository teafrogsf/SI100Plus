...
自从ChatGPT爆火之后，GPT三个字母突然出现在了公众视野里。GPT作为一个“统一的整体”出现的越来越普遍，也引发很多非常幽默~~令人忍俊不禁~~的新闻学奇观。

![img|900](image.png)

GPT究竟为什么会诞生？它最初是用来解决什么样的问题的？在它之前的模型又解决了什么样的问题？

第四章的内容将带你进入**自然语言处理（NLP, Natural Language Processing）**的世界。

<!-- 可是，我们的课程学到了今天，你有没有好奇过，GPT究竟是什么意思呢？
